...
export default function Loader({ text="Loading..." }: Props) {
    return (
        <div className="absolute left-0 top-0 flex min-h-full min-w-full items-center justify-center bg-[rgba(0,0,0,0.3)] dark:bg-[rgba(255,255,255,0.3)]">
            <div className="relative flex min-h-full flex-col items-center justify-center">
                <div role="status" className="flex flex-col items-center justify-center">
                    ...
                    <span className="ml-[-12px] text-center">{text}</span>
                </div>
            </div>
        </div>
    )
