...
export default function Offers({ offers }: Props) {
  if (offers?.length === 0) {
    return (
      <div className="mx-auto grid mt-5 mb-10 h-40 w-full place-items-center rounded-md border-2 border-dashed bg-gray-50 py-10 text-center dark:bg-gray-900">
        <div>
  ...
  return (
    <div className="grid grid-cols-1 gap-x-6 mt-5 mb-10 gap-y-10 sm:grid-cols-3 lg:col-span-3 lg:gap-x-8">
      {offers.map((offer) => (
